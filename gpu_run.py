...
class Config:
    ...
    JOBS = {
        "baseline_protodim100_prototypes_uniform_10" : "python3 train_cifar_proto.py --protodim=100 --learning-rate=1e-3 --save=checkpoints/baseline_protodim100_prototypes_uniform_10"
    }
